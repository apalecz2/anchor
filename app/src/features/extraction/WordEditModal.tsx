...
export const WordEditModal: React.FC<WordEditModalProps> = ({ initialData, onSave, onClose }) => {
    ...
    return (
        <Modal
            open
            onClose={onClose}
            labelledBy="word-edit-modal-title"
            // Scoped to the document pane (absolute), not the whole window.
            backdropClassName="absolute inset-0 flex items-center justify-center bg-black/40 z-50"
